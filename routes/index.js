...
router.get('/about', function(req, res, next) {
  res.render('index', { title: 'About Me', content: 'I am an avid strategy gamer. I\'ve been in Canada for 13 years now and in the Game Programming Course. I\'ve previously graduated from the Networking Course of Centennial but have gained interest in programming as I progressed through it.', img1: 'public/assets/images/Gaming.JPG', img2: 'public/assets/images/20200229_163441.jpg', img3: 'public/assets/images/WIN_20201009_19_52_10_Pro.jpg', img1label: 'strategy gamer', img2label: 'filipino food', img3label: 'a game programming student'});
});
router.get('/contact', function(req, res, next) {
  res.render('index', { title: 'Contact Me', content: 'Contact me through <br>Discord: otaku2932#5782<br>Email: c_lapis4@hotmail.com<br>', img1: 'public/assets/images/WIN_20201009_19_52_10_Pro.jpg', img2: 'public/assets/images/20190515_224121.jpg', img3: 'public/assets/images/102219_1135_TCPIPvsOSIM1.png', img1label: 'This is Me', img2label: 'Sterling Road Nestle', img3label: 'Most Basic Networking Picture'});
});
